...
class TimeRecordsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create time_record" do
    assert_difference("TimeRecord.count") do
      post time_records_url, params: { time_record: { current_time: @time_record.current_time } }
    end
  ...
  test "should update time_record" do
    patch time_record_url(@time_record), params: { time_record: { current_time: @time_record.current_time } }
